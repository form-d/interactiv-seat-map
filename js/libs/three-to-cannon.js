...
window.mesh2shape = CANNON.mesh2shape = mesh2shape;
...
function createBoundingBoxShape (object) {
  ...
  var center = new THREE.Vector3(); // .getCenter() target is now required'
	localPosition = box.translate(clone.position.negate()).getCenter(center);
